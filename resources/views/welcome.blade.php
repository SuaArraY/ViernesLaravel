                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2">
                        <div class="p-6">
                            ...
                            <!-- <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" class="w-8 h-8 text-gray-500"><path d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253"></path></svg> -->
                                <div class=subtitle><a href="https://www.despegar.com.pe/vuelos/"  target="_blank ">✈ Agencia de Viajes</a></div>
                            </div>
                        ...
                        <div class="p-6 border-t border-gray-200 dark:border-gray-700">
                            <div class="flex items-center">
                                ...
                                <div class=subtitle><a href="https://www.ef.com.pe/pg/campamentos-verano/" target="_blank" >⛺ Campamento</a></div>
                            </div>

                            <div class="ml-12">
                                <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                                ¿Quieres aprovechar al máximo tus vacaciones? ¡Lanza a tus hijos a la aventura de un campamento de verano ⛺️☀️! En nuestros programas incluímos clases de idiomas por las mañanas y todo tipo de actividades deportivas y culturales por las tardes para que aprovechen el tiempo al máximo.
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="p-6 border-t border-gray-200 dark:border-gray-700 md:border-l">
                            ...
                            <div class="ml-12">
                                <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                                Comparte el mejor momento entre amigos. Aquí se come como en casa pero sin tener que lavar los platos
                                </div>
                            </div>
                        </div>
                    </div>
